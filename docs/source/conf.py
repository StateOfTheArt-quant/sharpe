...
try:
    with open(join(root_path,"sharpe/VERSION.txt"), 'rb') as f:
...
html_logo = "_templates/_static/img/sharpe_logo.svg"

html_favicon = "_templates/_static/img/sharpe_logo.svg"
